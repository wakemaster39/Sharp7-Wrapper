...
namespace Sharp7
{
    ...
    public static class Conversion
    {
        ...
        {
            uint output;
            output = Sharp7.Types.DWord.FromByteArray(Sharp7.Types.Double.ToByteArray(input));
            return output;
        }
        ...
        {
            double output;
            output = Sharp7.Types.Double.FromByteArray(Sharp7.Types.DWord.ToByteArray(input));
            return output;
        }
    }
}
